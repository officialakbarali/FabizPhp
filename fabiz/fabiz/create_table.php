...
$BillDetailTableQuery = "CREATE TABLE IF NOT EXISTS " . BillDetail::$TABLE_NAME . " (
    ...
    " . BillDetail::$COLUMN_PRICE . " DECIMAL ,
    " . BillDetail::$COLUMN_QTY . " INT ,
    " . BillDetail::$COLUMN_RETURNED_TOTAL . " DECIMAL ,
    " . BillDetail::$COLUMN_CURRENT_TOTAL . " DECIMAL ,
    " . BillDetail::$COLUMN_PAID . " DECIMAL ,
    " . BillDetail::$COLUMN_DISCOUNT . " DECIMAL ,
    " . BillDetail::$COLUMN_DUE . " DECIMAL
...
$CartTableQuery = "CREATE TABLE IF NOT EXISTS " . Cart::$TABLE_NAME . " (
    ...
    " . Cart::$COLUMN_PRICE . " DECIMAL ,
    " . Cart::$COLUMN_QTY . " INT ,
    " . Cart::$COLUMN_TOTAL . " DECIMAL ,
    " . Cart::$COLUMN_RETURN_QTY . " DECIMAL
)ENGINE = INNODB;";
...
$SalesReturnTableQuery = "CREATE TABLE IF NOT EXISTS " . SalesReturn::$TABLE_NAME . " (
    ...
    " . SalesReturn::$COLUMN_PRICE . " DECIMAL ,
    " . SalesReturn::$COLUMN_QTY . " INT ,
    " . SalesReturn::$COLUMN_TOTAL . " DECIMAL
)ENGINE = INNODB;";
